...
"""Single-agent factory: one agent handles briefing, compose, and review together."""
...
def create_single_agent(user_id: str, session_id: str, jwt_token: str) -> tuple[Agent, list[dict]]:
    """Create a single Strands Agent that handles all phases (no compose_slides delegation).
    ...
    single_agent_template = load_prompt("single_agent")
