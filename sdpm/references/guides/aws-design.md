---
description: "AWS-specific design conventions — read when building AWS service content"
---
...
- General concepts → `search-assets --type general`
- Actual AWS services → `search-assets -s aws` to find the corresponding AWS icon
